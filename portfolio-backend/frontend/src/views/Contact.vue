          ...
          <v-card-text class="pa-4">
            <v-list>
              <v-list-item>
                ...
                <v-list-item-subtitle>ykaalogmichael@gmail.com</v-list-item-subtitle>
              </v-list-item>
              ...
              <v-list-item>
                ...
                <v-list-item-subtitle>github.com/ykaalogmichael-spec</v-list-item-subtitle>
              </v-list-item>
              ...
              <v-list-item>
                ...
                <v-list-item-subtitle>linkedin.com/in/ykaalogmichael</v-list-item-subtitle>
              </v-list-item>
            </v-list>
          </v-card-text>
        </v-card>
